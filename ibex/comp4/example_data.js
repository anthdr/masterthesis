...
var shuffleSequence = seq("intro", rshuffle("practice"), "sep", rshuffle(rshuffle("stat_low", "stat_high", "baseline"), rshuffle("filler", "FM")));
...
[["baseline",1],"completion", { html:'17+8= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Grégoire a collaboré avec les avocats de l’acteur qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",2],"completion", { html:'15+20= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Pierre a couru avec les amis de l’athlète qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",3],"completion", { html:'14+20= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Sandra a bavardé avec les jardiniers du millionnaire qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",4],"completion", { html:'15+14= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Joel a travaillé avec les stylistes de la célébrité qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",5],"completion", { html:'20+9= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Tina a étudié avec les médecins du mannequin qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",6],"completion", { html:'20+5= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Christophe a pardonné les sbires du dictateur qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",7],"completion", { html:'16+4= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Stéphane a dansé avec les fans du chanteur qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",8],"completion", { html:'9+15= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Christian a partagé avec le père des étudiants qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",9],"completion", { html:'18+17= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  George a divorcé du représentant des employés qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",10],"completion", { html:'5+13= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Paul est sorti avec le coach des cheerleaders qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",1],"completion", { html:'18+4= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Franck a logé chez les invités de la mariée qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",12],"completion", { html:'11+20= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Sarah a aimé le promoteur des musiciens qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",13],"completion", { html:'15+5= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Lucie a dîné avec le maître des élèves qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",14],"completion", { html:'5+18= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Jeanne a marché avec le meneur des manifestants qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",15],"completion", { html:'18+2= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Melissa a hebergé les filles du voisin qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",16],"completion", { html:'4+20= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Adrien a entraîné les assistants du PDG qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",17],"completion", { html:'18+2= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Alban a connu les comptables du ministre qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",18],"completion", { html:'12+9= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Louis a employé le manager des acteurs qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",19],"completion", { html:'7+19= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Carl a sympathisé avec l’agent des chanteurs qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
...
[["baseline",20],"completion", { html:'4+20= <input name="in" type="text" size="60" class="obligatory"  /> . '}, "completion", { html:  '  Rayan a vécu avec le capitaine des marins qui<input name="in" type="text" size="60" class="obligatory"  /> . '  }],
